...
public class DataProvider {
    ...
    private static List<Monyet> initDataMonyet(Context ctx) {
        ...
        monyets.add(new Monyet("Pigmy Marmoset", "Hutan Hujan Amazon",
                "merupakan jenis monyet terkecil di dunia, yang mempunyai warna bulu yang keemasan. Monyet ini sangat suka memakan cairan batang kayu", R.drawable.monyet_pigmy));
        monyets.add(new Monyet("Emperor Tamarin", "Amazon",
                "Konon katanya, monyet ini di sebut Emperor Tamarin karena mukanya yang mirip dengan Kaisar Jerman Wilhelm II", R.drawable.monyet_emperor));
        monyets.add(new Monyet("Proboscis", "Kalimantan,Indonesia",
                "merupakan monyet terganteng sedunia yang memiliki selaput pada kakinya yang menandakan monyet ini handal dalam hal berenang", R.drawable.monyet_ganteng));
        monyets.add(new Monyet("Simpanse", "Hutan dan sabana Afrika",
                "merupakan spesies kera besar dan memiliki 99 % DNA yang sama dengan manusia.", R.drawable.monyet_simpanse));
        return monyets;
    }
